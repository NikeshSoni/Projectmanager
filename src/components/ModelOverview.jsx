const ModelOverview = (
    ...
    return (
        <div data-aos="fade-left" className="bg-white my-3">
            ...
            <div className="modal fade bg-white" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className='border shadow border-dark m-5'>
                        <form className='p-3'>
