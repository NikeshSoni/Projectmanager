...
import CheckboxInput from './PreviewOutput';
import { UserContext } from '../Provider/UserContext';
import Delete from '../components/Delete';
import Model from './ModelOverview';

const EmployerDashBord = ({ data }) => {
    ...
    return (
        <>
            <div className='text-center my-4'>
                <h2 className='heading fs-2'>Job Post Manager </h2>
            </div>
            <div className={`App d-block  d-lg-flex ${isDarkMode ? 'bg-dark text-white' : 'bg-white'}`}>
                <div className='previewWapper d-block d-lg-none col-5 text-center mx-auto'>
                    <Model
                ...
                <div data-aos="fade-right" className="webpack p-4 mainnWapper mx-auto  border border-1 position-relative">
                    <Delete />
                    <div className='job-post-wrapper  jobsPost'>

                        {formstore.map((items, index) => {
                            return (
                                <div key={index} className='job-post-item border-0' >
                        ...
                        <div className="d-flex justify-content-between">
                            <div className='mt-3 d-flex gap-3'>
                                ...
                                <div>
                                    <Form.Control
                                        value={titleVal}
                                        // value={props.data.jobtitle || titleVal}
                            ...
                            <div className="toggleWapper align-items-center gap-4 d-flex">
                                ...
                                <input onClick={toggleTheme} id="checkbox" className='toggleInput' type="checkbox" />
                ...
                <div className='previewWapper d-none d-lg-block col-5 text-center mx-auto'>
                    <CheckboxInput
                        jobTitle={isTitle && <p>{titleVal}</p>}
                        main={isChecked && <p>{inputValue}</p>}
                        responsibility={isRoles && <p>{rolesVal}</p>}
